...
def view():
    ...
    totalPolledData = pd.read_excel(file, sheet_name='Polling Results', header=3, usecols='D:U', nrows=0)
    ...
    totalAttempted = pd.read_excel(file, sheet_name='Polling Results', header=8, usecols="A:U")
